function [paramx, options] = SPG_SAGA(model,X, y,X_test, y_test, options)
% SPG_SAGA is a code for image classification on 1-hidden layer network
% using SPG with SAGA.
%
%
% input & ouput: 
