function [paramx, options] = ADMM_SVRG(model,X, y,X_test, y_test, options)
% ADMM_SVRG is a code for image classification on 1-hidden layer network
% using SADMM with SVRG.
%
%
% input & ouput: 
...
for iter = cur+1: cur + max_iters
  ...
  for t =1:m  
   ...
   %%
   paramx = paramx_0- alpha *(grad+paramz+1/alpha*(paramx_0-paramy));   
